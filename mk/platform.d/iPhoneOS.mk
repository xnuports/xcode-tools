...
# assembled rather than assembled again.  lib/iphoneos-headers.txt is the
# restriction.  Unlike DriverKit this SDK's content sits at the top of the
# bundle, as macOS's does, so there is no XT_SDK_ROOT.
XT_SDK_HEADERS_CMD=	${TOP}/mk/scripts/install-sdk-headers.sh iPhoneOS \
			${TOP}/lib/iphoneos-headers.txt \
