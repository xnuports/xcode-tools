...
| Where | What |
|---|---|
| `usr/bin` | our 12 reimplementations, plus headerdoc, pngcrush, `xml2man`, `resolveLinks`, `make`/`gnumake`, `bsdmake`, `bmake` |
...
and `SetFile` (the first two of the resource tools, verified field by field
against Apple's own binaries),
